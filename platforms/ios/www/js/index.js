...
$('#id-pageregister-btn').on('click', function(e) {
    ...
    if (testEmail.test(document.getElementById('id-pageregister-useremail').value) && username) {
        ...
        if (!document.getElementById('id-pageregister-useremail').value || !username) {
            $("#id-pageerror-error-message").text('No Input!')
        } else {
            if (!testEmail.test(document.getElementById('id-pageregister-useremail').value)) {
                $("#id-pageerror-error-message").text('Wrong Email Format!')
            } else {
                $("#id-pageerror-error-message").text('Missing User Name!')
            }
        }
        page.changePage("#id-page-error");
        page.currentPage = "#id-page-register";
    }
