    ...
    displayCompetitors: function() {
        ...
        for (var i=0; i<4; i++) {
            ...
            if (this.competitors[i]) {
                ...
                $('#' + selector_bestman_divId + ' .ui-block-b h4').text(this.competitors[i].name);  // Insert bestman name in Blk B
                ...
                $('#' + selector_bestman_divId + ' .ui-block-b h4').text('');
    ...
    storeAndDisplayCompetitor4ConfirmPage: function() {
        ...
        for (var j=0; j<4; j++) {
            if (this.competitors[j]) {
                $('div.cls-page61-best' + j + '-div .ui-block-b h4').text(this.competitors[j].name);
...
var chatRoom = {
    ...
    displayChatRoomName: function(roomname) {
        $('#id-pagesucchat1-title').text(roomname)
    },
    displayAllChatRoomName: function() {
        ...
        if (this.ChatRoom) {
            for (var i=0; i<this.ChatRoom.length; i++) {
                newElemHtml += '<div><a><h4>' + this.ChatRoom[i].room + '</h4></a><img src="./img/symbol/remove.png" id="id-pagesucchat-delete" alt="trash"></div>';
            }
        }
